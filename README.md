...
- create react project by official cli tools: create-react-app hello-react
- basic TodoMVC in src/components 
  - src/App.js contains the TodoMVC components
- official temperature calculator example in src/reactBoiling
- rewrite the temperature calculator by EventEmitter in src/eventBoiling
- src/index.js is the test entry
